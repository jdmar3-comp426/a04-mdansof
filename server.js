...
app.patch("/app/update/user/:id", (req,res)=>{
	...
	res.status(200).json({"message": output.changes + " record updated: ID " + req.params.id + " (200)"})
})
...
app.delete("/app/delete/user/:id", (req,res) =>{
	...
	res.status(200).json({"message": output.changes + " record deleted: ID " + req.params.id + " (200)"})
})
